...
import { ProductMock, Check } from "../components/Art";
      ...
      <div className="wrap sd-grid">
        <div>
          <div className="cmap" style={{ minHeight: 0, aspectRatio: "1", borderRadius: 6, position: "relative", overflow: "hidden" }}>
            {photo ? <img src={photo.url} alt="Your upload preview" style={{ width: "100%", height: "100%", objectFit: "cover" }} /> : <ProductMock category={p.categorySlug} colors={p.colors} name={p.name} />}
          </div>
