    ...
    <>
      ...
      <section>
        <div className="wrap promos">
          <div className="promo"><ProductMock category="frames" colors={["Walnut"]} /><div className="inner"><p className="eyebrow" style={{ color: "var(--gold-soft)" }}>Keepsakes</p><h3>Frames &amp; personalised prints</h3><p>Upload your photo, choose a frame and size — we print, frame and deliver.</p><Link className="btn btn-light" to="/frames">Shop frames &amp; prints</Link></div></div>
